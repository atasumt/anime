...
class Data {
  ...
  Data({this.character, this.role, this.favorites, this.voiceActors});
...
class VoiceActors {
  ...
  VoiceActors.fromJson(Map<String, dynamic> json) {
    person = json['person'] != null ? new Character.fromJson(json['person']) : null;
