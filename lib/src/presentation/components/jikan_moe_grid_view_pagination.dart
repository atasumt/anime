...
class JikanMoeGridViewPagination extends StatefulWidget {
  ...
  @override
  State<JikanMoeGridViewPagination> createState() => _JikanMoeGridViewPaginationState();
}

class _JikanMoeGridViewPaginationState extends State<JikanMoeGridViewPagination> {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemCount: widget.onLoadingBuilder != null ? widget.itemCount + 1 : widget.itemCount,
      shrinkWrap: widget.shrinkWrap,
      itemBuilder: (context, index) {
        if (widget.onLoadingBuilder != null && index == widget.itemCount + 1) {
